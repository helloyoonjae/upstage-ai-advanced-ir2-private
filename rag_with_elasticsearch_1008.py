...
es_username = "elastic"
es_password = "C3UDUc+Jecd-+0+MIzyb"

# Elasticsearch client 생성
es = Elasticsearch(['https://localhost:9200'], 
                   basic_auth=(es_username, es_password), 
                   ca_certs='/data/ephemeral/home/code/elasticsearch-8.8.0/config/certs/http_ca.crt')
    ...
    "analysis": {
        "analyzer": {
            "nori_index_analyzer": { 
                ...
                "user_dictionary":"/data/ephemeral/home/code/elasticsearch-8.8.0/config/user_dictionary.txt",
        ...
        "filter": {
            ...
            "my_synonym_filter1": {
                "type": "synonym",
                "synonyms_path": "/data/ephemeral/home/code/elasticsearch-8.8.0/config/synonyms1.txt",
            },
            # "my_synonym_filter2": {
            #     "type": "synonym",
            #     "synonyms_path": "/data/ephemeral/home/code/elasticsearch-8.8.0/config/synonyms2.txt",
            # },
            "my_synonym_filter3": {
                "type": "synonym",
                "synonyms_path": "/data/ephemeral/home/code/elasticsearch-8.8.0/config/synonyms3.txt",
            },
            "my_synonym_filter4": {
                "type": "synonym",
                "synonyms_path": "/data/ephemeral/home/code/elasticsearch-8.8.0/config/synonyms4.txt",
            },
            "my_synonym_filter5": {
                "type": "synonym",
                "synonyms_path": "/data/ephemeral/home/code/elasticsearch-8.8.0/config/synonyms5.txt",
            },
             "my_synonym_filter6": {
                "type": "synonym",
                "synonyms_path": "/data/ephemeral/home/code/elasticsearch-8.8.0/config/synonyms6.txt",
            },
              "my_synonym_filter7": {
                "type": "synonym",
                "synonyms_path": "/data/ephemeral/home/code/elasticsearch-8.8.0/config/synonyms7.txt",
            }
...
#rescore_existing_results("/data/ephemeral/home/sample_submission6_roberta_sparse_fullprompt.csv", "/data/ephemeral/home/sample_submission8_roberta_hybrid_synonyms.csv")
